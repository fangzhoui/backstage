...
export default {
    ...
    methods: {
        ...
        getList(obj={page:1, pageSize:20}){
            // api_count.countList(obj).then(res=> {
            ...
            //         let obj = {
            //             title: a.title,
            //             productId: (a.productId==0) ? '还呗' : ((a.productId==1)?'爱贷': (a.productId==2)?'宜人贷': null),
            //             device: a.device,
        ...
        changeActiveFn(){
            ...
            //     this.productList = []
            // }else {
            //     api_active.itemList({fromKey: this.fromKey}).then(res=> {
